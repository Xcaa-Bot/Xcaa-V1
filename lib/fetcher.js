...
exports.getBuffer = getBuffer = async (url) => {
    ...
    const anu = fs.readFileSync('./image/error.png')
...
exports.createExif = (pack, auth) =>{
    ...
    const exif = {"sticker-pack-id": "com.xcaa.tech", "sticker-pack-name": pack, "sticker-pack-publisher": auth, "android-app-store-link": "https://play.google.com/store/apps/details?id=com.termux", "ios-app-store-link": "https://itunes.apple.com/app/sticker-maker-studio/id1443326857"}
